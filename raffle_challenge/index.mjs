...
console.log(`Creator is creating the test NFT`);
const theNFT = await stdlib.launchToken(accAlice, "The Starry Night", "NFT", { supply: 1 });
const nftParams = {
    nftId: theNFT.id,
    numTickets: 10.
};
const OUTCOME = ['Your number is not a match :(', 'Your number is a matches!'];
